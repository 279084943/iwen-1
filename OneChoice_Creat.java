...
public class OneChoice_Creat extends JFrame implements ActionListener{
	...
	public void Input(String str,String str1,String str2,String str3,String str4) throws IOException{
		...
		tmp2 = sa.Get_Tmp();	
		FileWriter pw = new FileWriter("C:/javacode/iwen/Project/"+tmp2+"/one.txt",true) ;
	    pw.write(str+"\r\n");
	    pw.write(str1+"\r\n");
	    pw.write(str2+"\r\n");
	    pw.write(str3+"\r\n");
	    pw.write(str4+"\r\n");
	    pw.close();
	    FileWriter pr = new FileWriter("C:/javacode/iwen/Project/"+tmp2+"/one_num.txt",true);
	    pr.write("0\r\n");
	    pr.write("0\r\n");
	    pr.write("0\r\n");
	    pr.write("0\r\n");	  
